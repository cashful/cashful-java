...
public class ForgotPasswordDto implements Serializable {
  ...
  public ForgotPasswordDto email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, forgotPasswordDto.email);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForgotPasswordDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ForgotPasswordDto is not found in the empty JSON string", ForgotPasswordDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ForgotPasswordDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ForgotPasswordDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
